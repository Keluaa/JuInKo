...
class JuliaImpl_1_7_2 : JuliaImplBase() {
    ...
    override fun jl_adopt_thread(): jl_gcframe_ptr = unavailable(JuliaVersion("1.9.0"))
    ...
    external override fun jl_symbol_name(s: jl_sym_t): String
    ...
    external override fun jl_astaggedvalue(v: jl_value_t): jl_taggedvalue_t
    external override fun jl_valueof(v: jl_taggedvalue_t): jl_value_t
    external override fun jl_typeof(v: jl_value_t): jl_value_t
    external override fun jl_get_fieldtypes(v: jl_value_t): jl_value_t
    ...
    external override fun jl_get_field_offset(ty: jl_datatype_ptr, field: Int): Long
    ...
    private class Internal {
        ...
        external fun jl_alignment(sz: Long): Int
    ...
    override fun jl_alignment(sz: Long) = internal.jl_alignment(sz)
